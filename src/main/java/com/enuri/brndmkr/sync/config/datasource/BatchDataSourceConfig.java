package com.enuri.brndmkr.sync.config.datasource;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.enuri.brndmkr.sync.repository.batch",
...
public class BatchDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean batchEntityManagerFactory() throws SQLException {
        ...
        em.setPackagesToScan("com.enuri.brndmkr.sync.model.batch");
